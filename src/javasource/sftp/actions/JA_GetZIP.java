 ...
 */
public class JA_GetZIP extends CustomJavaAction<Long>
{
	...
	public Long executeAction() throws Exception
	{
		...
		try {
			...
			if(SFTPused) {
				...
				reply =	FTPConnection.execute(DocumentParameter1, ConfigurationParameter1, ConnectionParameter1, null, context, Action.ZIP);
			}
			return (long) reply;
		} catch (Exception e) {
			e.printStackTrace();
