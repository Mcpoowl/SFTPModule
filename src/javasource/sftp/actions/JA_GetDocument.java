 ...
 */
public class JA_GetDocument extends CustomJavaAction<Boolean>
{
	...
	public Boolean executeAction() throws Exception
	{
		...
		try {
			...
			if(SFTPused) {
				...
				FTPConnection.execute(DocumentParameter1, ConfigurationParameter1, ConnectionParameter1, null, context, Action.GET);
			}
			return true;
		} catch (Exception e) {
			e.printStackTrace();
