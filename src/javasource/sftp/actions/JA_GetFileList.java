...
/**
 * Retrieves all folders and files in a specified folder (URL) and creates Document entities for each entry.
 * 
 * Connection = The user specific Connection entity
 * Configuration = The general Configuration entity
 */
public class JA_GetFileList extends CustomJavaAction<java.util.List<IMendixObject>>
{
	...
	public JA_GetFileList(IContext context, IMendixObject ConnectionParameter1, IMendixObject ConfigurationParameter1)
	{
		super(context);
	...
	public java.util.List<IMendixObject> executeAction() throws Exception
	{
		...
		try {
			...
			ArrayList<IMendixObject> DocumentList = new ArrayList<IMendixObject>();
			...
			if(SFTPused) {
				SFTPConnection.handleFile(null, ConfigurationParameter1, ConnectionParameter1, DocumentList, context, Action.LS);
			} else {
				FTPConnection.execute(null, ConfigurationParameter1, ConnectionParameter1, DocumentList, context, Action.LS);
			}
