 ...
 */
public class JA_CreateNewFolder extends CustomJavaAction<Long>
{
	...
	public Long executeAction() throws Exception
	{
		...
		try {
			...
			if(SFTPused) {
				...
				reply =	FTPConnection.execute(null, ConfigurationParameter1, ConnectionParameter1, null, context, Action.MKDIR);
			}
			return (long) reply;
		} catch (Exception e) {
			e.printStackTrace();
