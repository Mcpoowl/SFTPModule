 ...
 */
public class JA_SendDocument extends CustomJavaAction<Boolean>
{
	...
	public Boolean executeAction() throws Exception
	{
		...
		try {
			...
			if(SFTPused) {
				...
				FTPConnection.execute(DocumentParameter1, ConfigurationParameter1, ConnectionParameter1, null, context, Action.PUT);
			}
			return true;
		} catch (Exception e) {
			e.printStackTrace();
