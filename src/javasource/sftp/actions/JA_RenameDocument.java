 ...
 */
public class JA_RenameDocument extends CustomJavaAction<Long>
{
	...
	public Long executeAction() throws Exception
	{
		...
		try {
			...
			if(SFTPused) {
				...
				reply = FTPConnection.execute(null, ConfigurationParameter1, ConnectionParameter1, null, context, Action.RNM);
			}
